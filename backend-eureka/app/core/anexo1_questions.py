...
Estructura:
    5 secciones planas.
    Cada sección contiene directamente "questions".

Distribución:
    Gestión Administrativa:             12
    Gestión Técnica:                    38
    Gestión del Talento Humano:        10
    Procedimientos Operativos Básicos: 27
    Servicios Permanentes:              9

TOTAL: 96 preguntas.

IMPORTANTE:
No utilizar "subsections" como estructura de sección.
"subsection" únicamente sirve como metadata de cada pregunta.
"""
...
SECTIONS = [
    {
        ...
        "questions": [
            ...
            },
            {
                ...
                "legal_ref": "Decreto Ejecutivo 255 (2024) Art. 19.\nAcuerdo Ministerial 196 (2024) Art. 18 y 19.",
                "subsection": "Organización de seguridad y salud en el trabajo",
            },
            {
                "id": "A05",
                "text": "¿Cuenta con el registro del Técnico de Seguridad e Higiene del Trabajo en la Plataforma SUT?",
                "legal_ref": "Decreto Ejecutivo 255 (2024) Art. 20.\nAcuerdo Ministerial 196 (2024) Art. 18 y 19.",
                "subsection": "Organización de seguridad y salud en el trabajo",
            },
            {
                "id": "A06",
                "text": "¿Cuenta con el registro del Servicio Externo de Seguridad e Higiene del Trabajo en la Plataforma SUT?",
                "legal_ref": "Decreto Ejecutivo 255 (2024) Art. 25.\nAcuerdo Ministerial 196 (2024) Art. 14.",
                "subsection": "Organización de seguridad y salud en el trabajo",
            },
            {
                "id": "A07",
                "text": (
                    "¿Cuenta con el informe de actividades realizadas por técnico o "
                    "servicio externo de seguridad e higiene del trabajo? "
                    "El informe debe contener como mínimo:\n"
                    "- Objetivo\n"
                    "- Estadísticas básicas (accidentes de trabajo, incidentes y/o "
                    "presunción de enfermedades profesionales registradas)\n"
                    "- Principales actividades ejecutadas con detalle de las horas "
                    "de gestión asignadas a cada actividad\n"
                    "- Conclusiones\n"
            ...
            },
            {
                ...
                "legal_ref": "Decreto Ejecutivo 255 (2024) Art. 33.\nAcuerdo Ministerial 196 (2024) Art. 18 y 19.",
                "subsection": "Organización de seguridad y salud en el trabajo",
            },
            {
                "id": "A10",
                "text": "¿Cuenta con el registro del Comité de Seguridad y Salud en la plataforma SUT?",
                "legal_ref": "Decreto Ejecutivo 255 (2024) Art. 32.\nAcuerdo Ministerial 196 (2024) Art. 18 y 19.",
                "subsection": "Organización de seguridad y salud en el trabajo",
            },
            {
                "id": "A11",
                "text": (
                    "¿Cuenta con informe de la gestión realizada por los miembros "
                    "del Organismo Paritario? El informe debe contener como mínimo:\n"
                    "- Objetivo\n"
                    "- Cronograma con el detalle de las principales actividades "
                    "ejecutadas conforme las funciones descritas en el Art. 39 "
                    "del Decreto Ejecutivo Nro. 255\n"
                    "- Conclusiones\n"
                    "- Registro fotográfico\n"
                    "- Firmas de responsabilidad"
                ),
                "legal_ref": "Resolución 957 (2008) Art. 10, 13, 14.\nDecreto Ejecutivo 255 (2024) Art. 36 y Art. 38.",
                "subsection": "Organización de seguridad y salud en el trabajo",
            },
            {
                "id": "A12",
                "text": (
                    "¿Se evidencia por escrito los procedimientos generales que "
                    "establecen el deber de colaboración en la implementación de "
                    "las medidas de seguridad y salud en el trabajo para aquellos "
                    "empleadores que realizan actividades simultáneas en un mismo "
                    "lugar y/o centro de trabajo? (Esto incluye a contratistas, "
                    "subcontratistas y a todos los empleadores que deleguen o "
                    "encarguen trabajos a otras personas, ya sean naturales o "
        ...
        "questions": [
            ...
            },
            {
                ...
                "text": (
                    ...
                    "- Recursos utilizados: máquinas, equipos, herramientas, "
                    "materiales, agentes químicos y biológicos"
                ),
                "legal_ref": "Decisión 584 (2004) Art. 11, 19.\nCódigo del Trabajo Art. 42.\nDecreto Ejecutivo 255 (2024) Art. 28.",
                "subsection": "Identificación de peligros y evaluación de riesgos laborales",
            },
            {
                "id": "T03",
            ...
            },
            {
                "id": "T05",
                "text": (
                    "¿Cuenta con un informe de medición de agentes físicos, químicos "
                    "o biológicos?\nDebe incluir:\n"
                    "- Fecha de medición\n"
                ...
                "legal_ref": "Decisión 584 (2004) Art. 11, 12, 18.\nResolución 957 (2008) Art. 1.\nDecreto Ejecutivo 255 (2024) Art. 48.\nAcuerdo Ministerial 196 (2024).",
                "subsection": "Higiene Industrial",
            },
            {
                "id": "T06",
                "text": (
                    "¿Cuenta con un informe de evaluación de riesgos de seguridad, "
            ...
            },
            {
                "id": "T07",
                "text": (
                    "¿Cuenta con un informe de las medidas de prevención y protección "
                    "implementadas?\nDebe incluir:\n"
                    "- Fecha de elaboración\n"
                    "- Cronograma de implementación\n"
                    "- Medidas conforme la jerarquía de control "
            ...
            },
            {
                "id": "T36",
                "text": (
                    "¿Cuenta con procedimientos para trabajos especiales?\n"
                    "Debe incluir:\n"
                    "- Objetivo\n"
                    "- Responsable\n"
                    "- Puesto\n"
        ...
        "questions": [
            {
                "id": "H01",
                "text": (
                    "¿Se ha identificado a trabajadores que pertenecen a grupos "
                    "de atención prioritaria y/o en situación de vulnerabilidad "
                    "en las evaluaciones de riesgos laborales?\n"
                    "- Adultos mayores\n"
                    "- Mujeres en periodo de lactancia\n"
                    "- Mujeres embarazadas\n"
                    "- Trabajadores con discapacidad\n"
                    "- Trabajadores que adolezcan de enfermedades catastróficas "
                    "o de alta complejidad"
                ),
                "legal_ref": "Decreto Ejecutivo 255 (2024) Art. 28.\nDecisión 584 (2004) Art. 11.",
                "subsection": "Gestión preventiva en trabajadores que pertenecen a grupos de atención prioritaria y/o en situación de vulnerabilidad",
            },
            {
                "id": "H02",
                "text": (
                    "¿Se evidencia de forma in situ la implementación de medidas "
            ...
            },
            {
                ...
                "legal_ref": "Decreto Ejecutivo 255 (2024).\nAcuerdo Ministerial 196 (2024).",
            ...
            },
            {
                "id": "H05",
                "text": (
                    "¿El personal que opera vehículos a motor incluyendo maquinaria "
                    "agrícola cuenta con la licencia de conducción acorde con su "
                    "categoría según lo dispuesto por la autoridad competente?"
                ),
            ...
            },
            {
                "id": "H06",
                "text": (
                    "¿Cuenta con un registro de asistencia a inducciones o "
                    "reinducciones en seguridad y salud en el trabajo? "
                    "El registro debe contener como mínimo:\n"
                    "- Fecha de inducción\n"
                    "- Tema: riesgos laborales y medidas de prevención y protección\n"
                    "- Nombres y apellidos del trabajador\n"
                    "- Número de cédula\n"
                    "- Firmas de los trabajadores (física o electrónica, no se "
                    "aceptan firmas adulteradas)\n"
                    "- Nombres, cédula y firma del técnico de SST o responsable "
                    "del servicio externo\n"
                    "- Material utilizado\n"
                    "- Evaluación de conocimientos adquiridos"
                ),
                "legal_ref": "Decreto Ejecutivo 255 (2024) Art. 28.\nAcuerdo Ministerial 196 (2024).",
                "subsection": "Educación, capacitación y formación en materia de seguridad y salud en el trabajo",
            },
            {
                "id": "H07",
                "text": (
                    "¿Se han efectuado campañas de comunicación en seguridad y "
                    "salud en el trabajo?\n"
                    "- Deben existir respaldos físicos o digitales de las "
                    "campañas realizadas"
                ),
            ...
            },
            {
                "id": "H08",
                "text": (
                    "¿Cuenta con un programa de formación, capacitación y "
            ...
            },
            {
                "id": "H09",
                "text": (
                    "¿Cuenta con registros de asistencia a capacitaciones y "
                    "entrenamientos? Debe contener como mínimo:\n"
                    "- Fecha\n"
                    "- Tema\n"
                    "- Nombres y apellidos\n"
                    "- Número de cédula\n"
        ...
        "questions": [
            {
                "id": "O01",
                "text": (
                    "¿Cuenta con una matriz de exámenes médico ocupacionales por "
                    "puesto de trabajo, conforme los riesgos laborales a los que "
                    "se encuentren expuestos los trabajadores? La matriz deberá "
            ...
            },
            {
                "id": "O03",
                "text": (
                    "¿Cuenta con un informe de resultados de los exámenes médicos "
                    "ocupacionales, realizados por puesto de trabajo? "
                    "El informe debe contener como mínimo:\n"
                    "- Fecha de informe\n"
                    "- Periodo de exámenes\n"
                    "- Puesto de trabajo\n"
            ...
            },
            {
                "id": "O05",
                "text": (
                    "¿Cuenta con un informe trimestral de indicadores de enfermedad "
                    "común, enfermedad profesional y accidentes de trabajo? "
            ...
            },
            {
                "id": "O06",
                "text": (
                    "¿Cuenta con un procedimiento documentado de investigación de "
                    "accidentes de trabajo aprobado por la máxima autoridad del "
                    "lugar y/o centro de trabajo? El procedimiento debe contener "
                    "como mínimo:\n"
                    "- Objetivos\n"
                    "- Alcance\n"
                    "- Responsabilidades\n"
                    "- Procedimiento de investigación (notificación, reporte, "
            ...
            },
            {
                "id": "O07",
                "text": (
                    "¿Cuenta con un registro interno de incidentes y accidentes de "
                    "trabajo ocurridos en el lugar y/o centro de trabajo? "
                    "El registro debe contener como mínimo:\n"
            ...
            },
            {
                "id": "O08",
                "text": (
                    "¿Cuenta con un informe de investigación de accidentes de "
                    "trabajo? El informe debe contener como mínimo:\n"
            ...
            },
            {
                "id": "O14",
                "text": (
                    "¿Cuenta con un programa anual de ejecución de inspecciones "
            ...
            },
            {
                "id": "O16",
                "text": (
                    "¿Cuenta con un plan de emergencias y contingencia implementado "
                    "en el lugar y/o centro de trabajo? El plan debe contener como mínimo:\n"
                    "- Objetivos\n"
                    "- Alcance\n"
                    "- Identificación de amenazas naturales y riesgos antrópicos\n"
                    "- Procedimientos de emergencia (acciones a ejecutar antes, durante "
                    "y después de una emergencia)\n"
                    "- Mapa de recursos\n"
                    "- Mapa de evacuación\n"
                    "- Cronograma de inspecciones, pruebas y mantenimiento de los "
                    "sistemas de detección y extinción de incendios, entre otros\n"
                    "- Cronograma de ejecución de simulacros\n"
                    "- Conformación de brigadas\n"
                    "- Firmas de responsabilidad"
                ),
                "legal_ref": "Decreto Ejecutivo 2393 (1986).\nDecreto Ejecutivo 255 (2024).",
                "subsection": "Prevención de amenazas naturales y riesgos antrópicos",
            },
            {
                "id": "O17",
                "text": (
                    "¿Cuenta con un informe anual de los simulacros realizados? "
                    "El informe debe contener como mínimo:\n"
                    "- Fecha y hora del simulacro\n"
                    "- Objetivo del simulacro\n"
                    "- Tipo de simulacro realizado (incendio, evacuación, "
            ...
            },
            {
                "id": "O19",
                "text": (
                    "¿Cuenta con un programa de mantenimiento de instalaciones, "
                    "vehículos, máquinas, equipos y herramientas? "
                    "El programa debe contener como mínimo:\n"
                    "- Objetivos del programa\n"
                    "- Alcance\n"
                ...
                "subsection": "Mantenimiento de instalaciones, vehículos, máquinas, equipos y herramientas",
            },
            {
                "id": "O20",
            ...
            },
            {
                "id": "O21",
                "text": (
                    "¿Cuenta con un procedimiento de adquisición de equipos de "
                    "protección personal y ropa de trabajo? El procedimiento debe "
                    "contener como mínimo:\n"
                    "- Objetivo\n"
                    "- Alcance\n"
                    "- Responsabilidades\n"
                    "- Identificación de necesidades (evaluación de riesgos laborales, "
                    "proformas, entre otros)\n"
                    "- Matriz de equipos de protección personal, colectiva y ropa "
                    "de trabajo por puesto de trabajo (especificaciones técnicas, "
                    "lineamientos para el uso, mantenimiento, reposición y disposición "
                    "final, entre otros)\n"
                    "- Firmas de responsabilidad"
                ),
            ...
            },
            {
                "id": "O22",
                "text": (
                    "¿Cuenta con un registro de entrega recepción del equipo de "
                    "protección personal y ropa de trabajo a los trabajadores? "
                    "El registro debe contener como mínimo:\n"
                    "- Fecha de entrega\n"
                    "- Nombres y apellidos del trabajador\n"
                    "- Número de cédula\n"
                    ...
                    "- Firmas de los trabajadores (física o electrónica, no se "
                    "aceptan firmas pegadas o adulteradas)\n"
            ...
            },
            {
                "id": "O24",
                "text": (
                    "¿Se ha implementado el programa de prevención de riesgo "
                    "psicosocial? Presentar los respaldos de la implementación "
                    "de cada una de las actividades del programa:\n"
                    "- Actividad 1\n"
                    "- Actividad 2\n"
                    "- Actividad 3\n"
                    "- Actividad 4\n"
            ...
            },
            {
                "id": "O26",
                "text": (
                    "¿Se ha implementado el programa de prevención integral del "
                    "uso y consumo de alcohol, tabaco u otras drogas en los "
                    "espacios laborales públicos y privados? Presentar los "
                    "respaldos de la implementación de cada una de las actividades "
                    "del programa:\n"
                    "- Actividad 1\n"
                    "- Actividad 2\n"
                    "- Actividad 3\n"
...

    {
        ...
        "questions": [
            ...
            },
            {
                "id": "S02",
                "text": (
                    "¿El comedor cuenta con una adecuada salubridad y ambientación?\n"
                    "Aplica para centros de trabajo con cincuenta o más trabajadores "
                    "y situados a más de dos kilómetros de la población más cercana."
                ),
            ...
            },
            {
                "id": "S09",
                "text": (
                    "¿Cuenta con campamentos en buenas condiciones?\n"
                    "Debe incluir:\n"
                    "- Luz eléctrica\n"
                    "- Ventilación\n"
...
def get_all_questions() -> list:
    """
    Devuelve todas las preguntas en una lista plana.
...
def get_total_questions() -> int:
    """Devuelve el total de preguntas del Anexo 1."""
...
# Deben existir exactamente 5 sections.
assert len(SECTIONS) == 5, (
    f"Se esperaban 5 sections, existen {len(SECTIONS)}"
)


# Verificar IDs de sections.
actual_section_ids = [section["id"] for section in SECTIONS]

assert actual_section_ids == EXPECTED_SECTION_IDS, (
    f"Las sections no coinciden.\n"
    f"Esperadas: {EXPECTED_SECTION_IDS}\n"
    f"Actuales: {actual_section_ids}"
)


# Verificar cantidad de preguntas por section.
for section in SECTIONS:
    expected = EXPECTED_SECTION_COUNTS[section["id"]]
    actual = len(section["questions"])

    assert actual == expected, (
        f"La sección '{section['id']}' debe tener "
        f"{expected} preguntas, pero tiene {actual}"
    )


# Verificar total.
assert get_total_questions() == EXPECTED_TOTAL, (
    f"Se esperaban {EXPECTED_TOTAL} preguntas, "
    f"hay {get_total_questions()}"
)


# Verificar IDs duplicados.
_all_ids = [question["id"] for question in get_all_questions()]

_duplicates = {
    question_id
    for question_id in _all_ids
    if _all_ids.count(question_id) > 1
}

assert not _duplicates, (
    f"Existen IDs de preguntas duplicados: {_duplicates}"
)


# Verificar que todos los IDs sean únicos y estén presentes.
assert len(_all_ids) == len(set(_all_ids)), (
    "Los IDs de las preguntas deben ser únicos."
)
